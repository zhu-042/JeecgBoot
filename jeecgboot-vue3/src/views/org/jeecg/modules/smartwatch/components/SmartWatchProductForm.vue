...
<script lang="ts">
    ...
    import {getBpmFormSchema} from '../SmartWatchProduct.data';
    import {saveOrUpdate} from '../SmartWatchProduct.api';
    ...
    export default defineComponent({
        ...
        setup(props){
            ...
            let formData = {};
            const queryByIdUrl = '/org/jeecg/modules/smartwatch/smartWatchProduct/queryById';

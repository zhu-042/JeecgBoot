...
<script lang="ts">
    ...
    import {getBpmFormSchema} from '../CoffeeProduct.data';
    import {saveOrUpdate} from '../CoffeeProduct.api';
    ...
    export default defineComponent({
        ...
        setup(props){
            ...
            let formData = {};
            const queryByIdUrl = '/org/jeecg/modules/coffee/coffeeProduct/queryById';
